...
import { Users, Calendar, Trophy, TrendingUp, ArrowRight } from 'lucide-react';
...
export function DashboardPage() {
  const { players, events, ratings, records, settings, getUpcoming, getPast } = useApp();
    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {[
          ...
          { label: 'Assessments', value: ratings.length, icon: TrendingUp, color: 'text-purple-600 bg-purple-50' },
